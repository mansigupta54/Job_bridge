    ...
    <article id="mainArticle">
        <div class="container">
            ...
            <div class="card">
              ...
              <div class="card-body"><input placeholder="Post Something" style="height: 200px; width:100%;"></div> 
              <div class="card-footer"><button>LIKE</button> <button>COMMENT</button> <button>SHARE</button></div>
            </div>
          </div>
    </article>
    <nav id="mainNav">
        <div class="container">
            <div class="card" style="width:243px">
              ...
              <div class="card-body">
                ...
                <a href="view_profile.php" class="btn btn-primary">See Profile</a>
              </div>
            </div>
            <br>
    </nav>
